...
export default function FormReviews() {
  ...
  const changeHandler = ({target}: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    setValue({
      ...value,
  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <div className="reviews__rating-form form__rating">
        <input onChange={changeHandler} className="form__rating-input visually-hidden" name="rating" value="5" id="5-stars" type="radio"/>
      ...
      <textarea onChange={changeHandler} value={value.review} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"/>
